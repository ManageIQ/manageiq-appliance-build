...
describe Build::Target do
  ...
  it ".supported_types" do
    expect(described_class.supported_types).to match_array %w(openstack ovirt vsphere hyperv azure vagrant gce)
  end

  it ".default_types" do
    expect(described_class.default_types).to match_array %w(openstack ovirt vsphere hyperv azure vagrant gce)
  end
